  ...
  <form @submit.prevent="onSubmit">
    ...
    <Fieldset legend="Risk Management" :toggleable="true" class="p-mt-3" v-if="editableSettings.risk">
        <div class="p-fluid p-formgrid p-grid">
          ...
          <div class="p-field-checkbox p-col-12 p-md-4">
              <Checkbox id="riskExitOnOppositeSignal" v-model="editableSettings.risk.exitOnOppositeSignal" :binary="true" />
              <label for="riskExitOnOppositeSignal" class="p-ml-2">Выход по противоположному сигналу</label>
          </div>
